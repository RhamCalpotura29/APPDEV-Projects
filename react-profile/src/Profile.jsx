...
const Profile = () => {
  return (
    <div className="profile-container">
      <img
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVLXtNGWGeP9w92SZhQ60zAUQOhC1jKeIq1A&s"
        alt="profile-icon"
      ...
      <section id="education">
        ...
        <div>
          ...
          <ol>
            <li>Introduction to Cybersecurity Certificate (2023)</li>
            <li>Introduction to Packet Tracer Certificate (2022)</li>
          </ol>
        </div>
      </section>
